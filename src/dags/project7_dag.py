...
def spark_job():
    ...
    raw_to_ods_job = SparkSubmitOperator(
        ...
        **spark_resources,
        ...
        application_args=[
            ...
            '/user/s17503746/data/geo/events',
        ],
        retries=2,
    ...
    user_geodata_mart_job = SparkSubmitOperator(
        ...
        **spark_resources,
        ...
        application_args=[
            '/user/s17503746/data/geo/events',
            '/user/s17503746/data/analytics/users_geo',
            '/user/s17503746/data/geo_2.csv',
        ],
        retries=2,
        retry_delay=pendulum.duration(minutes=5),
    )
    ...
    geo_activity_stats_mart_job = SparkSubmitOperator(
        ...
        **spark_resources,
        ...
        application_args=[
            '/user/s17503746/data/geo/events',
            '/user/s17503746/data/analytics/geo_activity_stats',
            '/user/s17503746/data/geo_2.csv',
            '/user/s17503746/data/analytics/users_geo',
        ],
        retries=2,
    ...
    friend_recommendations_mart_job = SparkSubmitOperator(
        ...
        **spark_resources,
        ...
        application_args=[
            '/user/s17503746/data/geo/events',
            '/user/s17503746/data/analytics/friend_recommendations',
            '/user/s17503746/data/geo_2.csv',
            '/user/s17503746/data/analytics/users_geo',
        ],
        retries=2,
